...
* **Functions to have in mind:
  * chr(): takes integer & converts to its ASCII character representation.
  * hex(): takes integer & converts to hexadecimal.
  * ord(): takes character & converts to its ascii unicode representation. 
